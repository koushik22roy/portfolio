...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title">Koushik Roy 
            {/* <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <h3 className="home__subtitle">Unity/Games/AR Developer</h3>

            {/* <p className="home__description">I am Unity Developer from New Delhi</p> */}
