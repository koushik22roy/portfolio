            ...
            <div className="qualification__container container">
                ...
                <div className="qualification__sections">
                    <div className={toggleState === 1 ? "qualification__content qualification__content-active"
                        ...
                        <div className="qualification__data">
                            <div>
                                ...
                                <span className="qualification__subtitle">SRM University
                                </span>
                        ...
                        <div className="qualification__data">
                            ...
                            <div>
                                ...
                                <span className="qualification__subtitle">KCC Institute Of Legal and Higher Education
                                </span>
                                <div className="qualification__calender">
                    ...
                    <div className={toggleState === 2 ? "qualification__content qualification__content-active"
                        ...
                        <div className="qualification__data">
                            <div>
                                <h3 className="qualification__title">Unity Developer</h3>
                                <span className="qualification__subtitle">DJ Interactive
                                </span>
                                <div className="qualification__calender">
                                    <i className="uil uil-calender-alt"></i>2022 - Present
                                </div>
                        ...
                        <div className="qualification__data">
                            ...
                            <div>
                                <h3 className="qualification__title">Game Developer Intern</h3>
                                <span className="qualification__subtitle">Mitambi Solutions
                                </span>
                                <div className="qualification__calender">
